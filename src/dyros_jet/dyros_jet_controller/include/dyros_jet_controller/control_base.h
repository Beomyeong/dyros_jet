...
public:
  ...
  VectorQd q_init_state_;
  VectorQd q_target_state_;
...
private:
  ...
  ros::Subscriber walking_joy_ui_command_sub_;
  ...
  void joyUiCommandCallback(const dyros_jet_msgs::WalkingCommandConstPtr& msg);
  void joyCommandCallback(const dyros_jet_msgs::WalkingCommandConstPtr& msg);
