  ...
  , isConnected(false)
{
  ...
  QObject::connect(ui.kettle, SIGNAL(clicked()),this,SLOT(stateButtonClicked()));
  QObject::connect(ui.cup1, SIGNAL(clicked()),this,SLOT(stateButtonClicked()));
  QObject::connect(ui.cup2, SIGNAL(clicked()),this,SLOT(stateButtonClicked()));
  QObject::connect(ui.stick, SIGNAL(clicked()),this,SLOT(stateButtonClicked()));
  QObject::connect(ui.stick_up, SIGNAL(clicked()),this,SLOT(stateButtonClicked()));
  QObject::connect(ui.mix1, SIGNAL(clicked()),this,SLOT(stateButtonClicked()));
  QObject::connect(ui.kettle_ori, SIGNAL(clicked()),this,SLOT(stateButtonClicked()));
  QObject::connect(ui.coffee_init, SIGNAL(clicked()),this,SLOT(stateButtonClicked()));

  QObject::connect(ui.button_yattention, SIGNAL(clicked()), this, SLOT(stateButtonClicked()));
  QObject::connect(ui.button_ybottle_a, SIGNAL(clicked()), this, SLOT(stateButtonClicked()));
  QObject::connect(ui.button_ybottle_b, SIGNAL(clicked()), this, SLOT(stateButtonClicked()));
  QObject::connect(ui.button_ygive, SIGNAL(clicked()), this, SLOT(stateButtonClicked()));
  QObject::connect(ui.button_ygreet, SIGNAL(clicked()), this, SLOT(stateButtonClicked()));

  QObject::connect(ui.button_mission_picture1, SIGNAL(clicked()),this,SLOT(stateButtonClicked()));
  QObject::connect(ui.button_mission_picture2, SIGNAL(clicked()),this,SLOT(stateButtonClicked()));
  QObject::connect(ui.button_mission_picture4, SIGNAL(clicked()),this,SLOT(stateButtonClicked()));
  QObject::connect(ui.button_mission_bucket, SIGNAL(clicked()),this,SLOT(stateButtonClicked()));
  QObject::connect(ui.button_mission_stretch_arm, SIGNAL(clicked()),this,SLOT(stateButtonClicked()));
  QObject::connect(ui.button_mission_plate, SIGNAL(clicked()),this,SLOT(stateButtonClicked()));
  QObject::connect(ui.button_mission_scoop, SIGNAL(clicked()),this,SLOT(stateButtonClicked()));
  QObject::connect(ui.button_mission_refill, SIGNAL(clicked()),this,SLOT(stateButtonClicked()));
  QObject::connect(ui.button_mission_heart_pose, SIGNAL(clicked()),this,SLOT(stateButtonClicked()));
