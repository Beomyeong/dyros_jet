...
def main():
	...
	joint_init_goal.command.position = [0 , 0.034906585 , 0.03558 , 0.5184 , -0.5544 , -0.034906585, 0 , -0.034906585 , -0.03558 , -0.5184 , 0.5544 , 0.034906585, 0, 0.6981317008 , -1.6580627893 , -1.3962634016 , -1.9198621771 ,0 ,  0 , -1.2217304764 , -0.1745329252, -0.6981317008 , 1.6580627893 , 1.3962634016 , 1.9198621771 , 0 , 1.2217304764 , 0.17453292519, 0 , 0 , 0 , 0]
...
#
    ...
    joint_goal_temp.command.name =  ['L_HipYaw','L_HipRoll','L_HipPitch','L_KneePitch','L_AnklePitch','L_AnkleRoll','R_HipYaw','R_HipRoll','R_HipPitch','R_KneePitch','R_AnklePitch','R_AnkleRoll','WaistPitch','WaistYaw', 'L_ShoulderPitch','L_ShoulderRoll','L_ShoulderYaw','L_ElbowRoll','L_WristYaw','L_WristRoll','L_HandYaw', 'R_ShoulderPitch','R_ShoulderRoll','R_ShoulderYaw','R_ElbowRoll','R_WristYaw','R_WristRoll','R_HandYaw','HeadYaw', 'HeadPitch', 'R_Gripper', 'L_Gripper']
    #msg.enable = [True, True, True, True, True, True, True, True, True, True, True, True, True, True, True, True, True, True, True, True, True, True, True, True, True, True, True, True, False, False, False, False]
	...
	joint_goal_temp.command.position = [0.3 , 0.034906585 , 0.03558 , 0.5184 , -0.5544 , -0.034906585, 0 , -0.034906585 , -0.03558 , -0.5184 , 0.5544 , 0.034906585, 0, 0.6981317008 , -1.6580627893 , -1.3962634016 , -1.9198621771 ,0 ,  0 , -1.2217304764 , -0.1745329252, -0.6981317008 , 1.6580627893 , 1.3962634016 , 1.9198621771 , 0 , 1.2217304764 , 0.17453292519, 0 , 0 , 0 , 0]
