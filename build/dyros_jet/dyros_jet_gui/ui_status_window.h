...
public:
    ...
    QPushButton *button_yattention;
    QPushButton *button_ybottle_a;
    QPushButton *button_ybottle_b;
    QPushButton *button_ygive;
    QPushButton *button_ygreet;
    ...
    QPushButton *button_mission_picture1;
    QPushButton *button_mission_picture2;
    QPushButton *button_mission_heart_pose;
    QPushButton *button_mission_picture4;
    QPushButton *button_mission_bucket;
    QPushButton *button_mission_stretch_arm;
    QPushButton *button_mission_plate;
    QPushButton *button_mission_scoop;
    QPushButton *button_mission_refill;
    ...
    QPushButton *cup2;
    QPushButton *stick;
    QPushButton *stick_up;
    QPushButton *mix1;
    QPushButton *kettle_ori;
    QPushButton *coffee_init;
    ...
    void setupUi(QMainWindow *StatusWindow)
    {
        ...
        button_yattention = new QPushButton(groupBox_state);
        button_yattention->setObjectName(QString::fromUtf8("button_yattention"));
        button_yattention->setMinimumSize(QSize(0, 50));

        verticalLayout_8->addWidget(button_yattention);

        button_ybottle_a = new QPushButton(groupBox_state);
        button_ybottle_a->setObjectName(QString::fromUtf8("button_ybottle_a"));
        button_ybottle_a->setMinimumSize(QSize(0, 50));

        verticalLayout_8->addWidget(button_ybottle_a);

        button_ybottle_b = new QPushButton(groupBox_state);
        button_ybottle_b->setObjectName(QString::fromUtf8("button_ybottle_b"));
        button_ybottle_b->setMinimumSize(QSize(0, 50));

        verticalLayout_8->addWidget(button_ybottle_b);

        button_ygive = new QPushButton(groupBox_state);
        button_ygive->setObjectName(QString::fromUtf8("button_ygive"));
        button_ygive->setMinimumSize(QSize(0, 50));

        verticalLayout_8->addWidget(button_ygive);

        button_ygreet = new QPushButton(groupBox_state);
        button_ygreet->setObjectName(QString::fromUtf8("button_ygreet"));
        button_ygreet->setMinimumSize(QSize(0, 50));

        verticalLayout_8->addWidget(button_ygreet);
        ...
        button_mission_picture1 = new QPushButton(groupBox_state);
        button_mission_picture1->setObjectName(QString::fromUtf8("button_mission_picture1"));
        button_mission_picture1->setMinimumSize(QSize(0, 40));

        verticalLayout_11->addWidget(button_mission_picture1);

        button_mission_picture2 = new QPushButton(groupBox_state);
        button_mission_picture2->setObjectName(QString::fromUtf8("button_mission_picture2"));
        button_mission_picture2->setMinimumSize(QSize(0, 40));

        verticalLayout_11->addWidget(button_mission_picture2);

        button_mission_heart_pose = new QPushButton(groupBox_state);
        button_mission_heart_pose->setObjectName(QString::fromUtf8("button_mission_heart_pose"));
        button_mission_heart_pose->setMinimumSize(QSize(0, 40));

        verticalLayout_11->addWidget(button_mission_heart_pose);

        button_mission_picture4 = new QPushButton(groupBox_state);
        button_mission_picture4->setObjectName(QString::fromUtf8("button_mission_picture4"));
        button_mission_picture4->setMinimumSize(QSize(0, 40));

        verticalLayout_11->addWidget(button_mission_picture4);

        button_mission_bucket = new QPushButton(groupBox_state);
        button_mission_bucket->setObjectName(QString::fromUtf8("button_mission_bucket"));
        button_mission_bucket->setMinimumSize(QSize(0, 40));

        verticalLayout_11->addWidget(button_mission_bucket);

        button_mission_stretch_arm = new QPushButton(groupBox_state);
        button_mission_stretch_arm->setObjectName(QString::fromUtf8("button_mission_stretch_arm"));
        button_mission_stretch_arm->setMinimumSize(QSize(0, 40));

        verticalLayout_11->addWidget(button_mission_stretch_arm);

        button_mission_plate = new QPushButton(groupBox_state);
        button_mission_plate->setObjectName(QString::fromUtf8("button_mission_plate"));
        button_mission_plate->setMinimumSize(QSize(0, 40));

        verticalLayout_11->addWidget(button_mission_plate);

        button_mission_scoop = new QPushButton(groupBox_state);
        button_mission_scoop->setObjectName(QString::fromUtf8("button_mission_scoop"));
        button_mission_scoop->setMinimumSize(QSize(0, 40));

        verticalLayout_11->addWidget(button_mission_scoop);

        button_mission_refill = new QPushButton(groupBox_state);
        button_mission_refill->setObjectName(QString::fromUtf8("button_mission_refill"));
        button_mission_refill->setMinimumSize(QSize(0, 40));

        verticalLayout_11->addWidget(button_mission_refill);
        ...
        kettle = new QPushButton(centralwidget);
        kettle->setObjectName(QString::fromUtf8("kettle"));

        verticalLayout_2->addWidget(kettle);

        cup1 = new QPushButton(centralwidget);
        cup1->setObjectName(QString::fromUtf8("cup1"));

        verticalLayout_2->addWidget(cup1);

        cup2 = new QPushButton(centralwidget);
        cup2->setObjectName(QString::fromUtf8("cup2"));

        verticalLayout_2->addWidget(cup2);

        stick = new QPushButton(centralwidget);
        stick->setObjectName(QString::fromUtf8("stick"));

        verticalLayout_2->addWidget(stick);

        stick_up = new QPushButton(centralwidget);
        stick_up->setObjectName(QString::fromUtf8("stick_up"));

        verticalLayout_2->addWidget(stick_up);

        mix1 = new QPushButton(centralwidget);
        mix1->setObjectName(QString::fromUtf8("mix1"));

        verticalLayout_2->addWidget(mix1);

        kettle_ori = new QPushButton(centralwidget);
        kettle_ori->setObjectName(QString::fromUtf8("kettle_ori"));

        verticalLayout_2->addWidget(kettle_ori);

        coffee_init = new QPushButton(centralwidget);
        coffee_init->setObjectName(QString::fromUtf8("coffee_init"));

        verticalLayout_2->addWidget(coffee_init);
        ...
        menubar->setGeometry(QRect(0, 0, 1823, 25));
    ...
    void retranslateUi(QMainWindow *StatusWindow)
    {
        ...
        button_yattention->setText(QApplication::translate("StatusWindow", "button_yattention", 0, QApplication::UnicodeUTF8));
        button_ybottle_a->setText(QApplication::translate("StatusWindow", "button_ybottle_a", 0, QApplication::UnicodeUTF8));
        button_ybottle_b->setText(QApplication::translate("StatusWindow", "button_ybottle_b", 0, QApplication::UnicodeUTF8));
        button_ygive->setText(QApplication::translate("StatusWindow", "button_ygive", 0, QApplication::UnicodeUTF8));
        button_ygreet->setText(QApplication::translate("StatusWindow", "button_ygreet", 0, QApplication::UnicodeUTF8));
        ...
        button_mission_picture1->setText(QApplication::translate("StatusWindow", "Take picture", 0, QApplication::UnicodeUTF8));
        button_mission_picture2->setText(QApplication::translate("StatusWindow", "Take picture2", 0, QApplication::UnicodeUTF8));
        button_mission_heart_pose->setText(QApplication::translate("StatusWindow", "HeartPose", 0, QApplication::UnicodeUTF8));
        button_mission_picture4->setText(QApplication::translate("StatusWindow", "Take picture3", 0, QApplication::UnicodeUTF8));
        button_mission_bucket->setText(QApplication::translate("StatusWindow", "Hold bucket", 0, QApplication::UnicodeUTF8));
        button_mission_stretch_arm->setText(QApplication::translate("StatusWindow", "Stretch arm", 0, QApplication::UnicodeUTF8));
        button_mission_plate->setText(QApplication::translate("StatusWindow", "Hold plate", 0, QApplication::UnicodeUTF8));
        button_mission_scoop->setText(QApplication::translate("StatusWindow", "Scoop", 0, QApplication::UnicodeUTF8));
        button_mission_refill->setText(QApplication::translate("StatusWindow", "Refill", 0, QApplication::UnicodeUTF8));
        ...
        kettle->setText(QApplication::translate("StatusWindow", "kettle", 0, QApplication::UnicodeUTF8));
        cup1->setText(QApplication::translate("StatusWindow", "cup1", 0, QApplication::UnicodeUTF8));
        cup2->setText(QApplication::translate("StatusWindow", "cup2", 0, QApplication::UnicodeUTF8));
        stick->setText(QApplication::translate("StatusWindow", "stick", 0, QApplication::UnicodeUTF8));
        stick_up->setText(QApplication::translate("StatusWindow", "stick_up", 0, QApplication::UnicodeUTF8));
        mix1->setText(QApplication::translate("StatusWindow", "mix1", 0, QApplication::UnicodeUTF8));
        kettle_ori->setText(QApplication::translate("StatusWindow", "kettle_ori", 0, QApplication::UnicodeUTF8));
        coffee_init->setText(QApplication::translate("StatusWindow", "coffee_init", 0, QApplication::UnicodeUTF8));
