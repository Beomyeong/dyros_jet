...
public:
    ...
    void setupUi(QMainWindow *TaskWindow)
    {
        ...
        button_joy_walk = new QPushButton(groupBox_walk_ctrl);
        button_joy_walk->setObjectName(QString::fromUtf8("button_joy_walk"));

        verticalLayout_39->addWidget(button_joy_walk);
        ...
        comboBox_method->setCurrentIndex(2);
    ...
    void retranslateUi(QMainWindow *TaskWindow)
    {
        ...
        comboBox_method->insertItems(0, QStringList()
         ...
         << QApplication::translate("TaskWindow", "QP", 0, QApplication::UnicodeUTF8)
        );
        ...
        button_joy_walk->setText(QApplication::translate("TaskWindow", "Joystick Walking", 0, QApplication::UnicodeUTF8));
